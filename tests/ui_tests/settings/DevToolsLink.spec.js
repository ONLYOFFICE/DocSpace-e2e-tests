...
import { PortalLoginPage } from "../../../page_objects/portal_login_page";
    ...
    test.afterAll(async () => {
      ...
      test('JSDK link', async ({ page }) => {
        ...
        const page1 = await page1Promise;
        await page1.waitForURL('https://*.onlyoffice.com/docspace/javascript-sdk/get-started/basic-concepts/');
        await expect(page1).toHaveURL(/docspace\/javascript-sdk\/get-started\/basic-concepts/);
        const page2Promise = page.waitForEvent('popup');
