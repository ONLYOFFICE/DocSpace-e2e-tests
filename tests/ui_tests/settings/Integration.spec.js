...
>>>>>>> main
  ...
  test.skip('Ldap - временно отключено', async ({ page }) => {
    ...
    await expect(page.locator('text=100% Operation has been successfully completed')).toBeVisible({
      timeout: 3000,
    });
  ...
  test('Smtp', async ({ page }) => {
    ...
    await expect(page.locator('text=Settings have been successfully updated')).toHaveText(
    ...
    await page.waitForTimeout(2000);
    await expect(page.locator('text=Operation has been successfully completed.')).toHaveText(
  ...
  test('Facebook Enable', async ({ page }) => {
    ...
    await expect(page.locator('text=Updated successfully')).toHaveText('Updated successfully', {
      timeout: 10000,
    });
