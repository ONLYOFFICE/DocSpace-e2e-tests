...
test.describe('Security Tests', () => {
  ...
  test('Login History', async ({ page }) => {
    ...
    await expect(page.locator('text=Successful Login via API').first()).toHaveText(
  ...
  test('Audit Trail', async ({ page }) => {
    ...
    await expect(page.locator('text=Language Updated').first()).toHaveText('Language Updated', {
      timeout: 10000,
    });
  });
