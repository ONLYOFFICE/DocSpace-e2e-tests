...
import { PortalLoginPage } from "../../../page_objects/portal_login_page";
    ...
    test.afterAll(async () => {
      ...
      test('Delete portal', async ({ page }) => {
        ...
        await page.waitForTimeout(1000);
        await expect(page.getByTestId('text').filter({ hasText: 'A link to confirm the' }).first()).toContainText('A link to confirm the operation has been sent to', { timeout: 10000 });
      });
