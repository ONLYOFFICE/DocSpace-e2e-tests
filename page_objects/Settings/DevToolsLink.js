...
export class DevToolsLink extends MainPage {
  constructor(page) {
    ...
    this.readInstructionsButton = page.getByRole("button", {
    ...
    this.speechToTextArea = page.getByText(
      "speech-to-textVer. 1.0.2Speech to Text Conversion is a speech recognition",
    );
