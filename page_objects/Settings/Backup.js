...
export class Backup extends MainPage {
  constructor(page) {
    ...
    this.forwardDocuments = page
      .getByTestId("selector")
      .getByRole("paragraph")
      .filter({ hasText: "Documents" });
    this.selectButton = page.getByRole("button", { name: "Select" });
    this.timeCombobox = page
      .getByTestId("combobox")
      .and(page.locator(".schedule-backup_combobox.time_options"));
    ...
    this.periodBox = page
      .getByTestId("combobox")
      .and(page.locator(".schedule-backup_combobox.days_option"));
    this.selectPeriod = page.getByText("Every week");
    this.dayBox = page
      .getByTestId("combobox")
      .and(page.locator(".schedule-backup_combobox.weekly_option"));
    this.selectDay = page.getByText("Friday");
    this.monthBox = page
      .getByTestId("combobox")
      .and(page.locator(".schedule-backup_combobox.monthly_option"));
    this.selectEveryMonth = page
      .getByTestId("drop-down-item")
      .filter({ hasText: "Every month" });
    this.monthSelectorBox = page
      .getByTestId("combobox")
      .and(page.locator(".schedule-backup_combobox.month_options"));
    ...
    this.createBackupButton = page
      .getByTestId("button")
      .filter({ hasText: "Create" });
    this.createCopyButton = page
      .getByTestId("button")
      .filter({ hasText: "Create copy" });
    this.selectBackupRoom = page.locator("#backup-room path");
    this.selectThirdPartyStorage = page.locator("#third-party-storage path");
    this.bucketInput = page
      .getByTestId("text-input")
      .and(page.locator('[name="bucket"]'));
    this.regionCombobox = page
      .getByTestId("combobox")
      .and(page.locator(".region-combo-box"));
    this.regionSelect = page
      .getByTestId("drop-down-item")
      .and(page.locator(".drop-down-item"))
      .filter({ hasText: "US East (N. Virginia) (us-east-1)" });
    ...
    this.selectNextcloud = page
      .getByTestId("drop-down-item")
      .and(page.locator('[data-third-party-key="Nextcloud"]'));
    this.connectButton = page
      .getByTestId("button")
  ...
  async s3Backup() {
    ...
    await this.page.evaluate(() => {
      ...
      const containers = [
        ...
        document.querySelector(
          ".combo-button_opened .ScrollbarsCustom-Content",
        ),
    ...
    const usEastOption = this.page.getByText(
