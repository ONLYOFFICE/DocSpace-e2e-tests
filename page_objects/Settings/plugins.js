...
export class Plugins extends MainPage {
    constructor(page) {
        ...
        this.markdownSettingsButton = this.markdownArea.locator('.plugin-controls > .sc-fqkvVR > .icon-button_svg > div > .injected-svg');
        this.markdownEnableSwitch = this.markdownArea.locator('circle');
        this.drawIoArea = page.getByText('draw.io 1.0.2A tool for');
        this.drawIoSettingsButton = this.drawIoArea.locator('.plugin-controls > .sc-fqkvVR > .icon-button_svg > div > .injected-svg');
        this.drawIoEnableSwitch = this.drawIoArea.locator('circle');
        this.speechToTextArea = page.getByText('speech-to-text 1.0.2Speech to');
        this.speechToTextSettingsButton = this.speechToTextArea.locator('.plugin-controls > .sc-fqkvVR > .icon-button_svg > div > .injected-svg');
        ...
        this.pdfConverterSettingsButton = this.pdfConverterArea.locator('.plugin-controls > .sc-fqkvVR > .icon-button_svg > div > .injected-svg');
