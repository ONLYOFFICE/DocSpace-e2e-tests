...
export class Integration extends MainPage {
  constructor(page) {
    ...
    this.ldapUserDininput = page.locator(
      'input[name="userDN"][data-testid="text-input"]',
    );
    this.ldapUserFilterInput = page.getByText("(uid=*)");
    this.ldapLoginInput = page.locator('input[name="login"]');
    this.ldapPasswordInput = page
    ...
    this.smtpSendTestMail = page.getByRole("button", {
      name: "Send Test Mail",
    });
    ...
    this.facebookSwitch = page.locator(
      '[data-consumer="facebook"][data-testid="box"]',
    );
