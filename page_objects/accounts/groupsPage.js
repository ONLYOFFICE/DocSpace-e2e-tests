...
export class GroupsPage {
  constructor(page) {
    ...
    this.chooseManager =
      "[data-testid='text']:has-text('admin-zero admin-zero')";
  ...
  async clickMobileActionButton() {
    //click mobile action button on group page
    let maxAttempts = 5;
    let attempt = 0;
  ...
  async editGroup(updatedGroupName) {
    ...
    await this.page.waitForSelector(this.textInputGroupName, {
      state: "visible",
    });
