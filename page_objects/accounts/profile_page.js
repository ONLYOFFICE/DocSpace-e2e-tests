export class ProfilePage {
  constructor(page) {
    ...
    this.firstNameInput = "[data-testid='text-input'][placeholder='First name']";
    this.lastNameInput = "[data-testid='text-input'][placeholder='Last name']";
    this.saveButton = "[data-testid='button'][tabindex='3']";
    this.changePasswordButton = "div.profile-block-field.profile-block-password [data-testid='icon-button']";
    this.sendPasswordChangeButton = "[data-testid='button']";

    // Language Selector
    this.languageSelector = "div.language-combo-box-wrapper [data-testid='combobox']";
    this.germanLanguageOption = "[data-testid='drop-down-item'] >> text=Deutsch";
    this.englishLanguageOption = "[data-testid='drop-down-item'] >> text=English";
