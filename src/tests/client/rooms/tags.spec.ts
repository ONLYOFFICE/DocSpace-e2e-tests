...
test.describe("Tags", () => {
  ...
  test("Tag Create,Filter,Delete", async () => {
    ...
    await test.step("DeleteTagFromRoom", async () => {
      ...
      await myRooms.roomsTable.clickContextMenuOption(roomContextMenuOption.editRoom);
    ...
    await test.step("CreateFiveTagsInRoom", async () => {
      ...
      await myRooms.roomsCreateDialog.selectCoverIcon();
      await myRooms.roomsCreateDialog.saveCover();
      await myRooms.roomsCreateDialog.fillRoomName('ManyTags RoomManyTags RoomManyTags RoomManyTags RoomManyTags RoomManyTags Room');
    ...
    await test.step("CollapsingLongNameTag", async () => {
      ...
      await myRooms.roomsCreateDialog.createTag('0123456789 0123456789 0123456789 0123456789 0123456789 0123456789 0123456789 0123456789 0123456789 0123456789');
      await myRooms.roomsCreateDialog.clickRoomDialogSubmit();
