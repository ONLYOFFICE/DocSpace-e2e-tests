...
test.describe("Daily prod check: Rooms", () => {
  let myRooms: MyRooms;
...
test.describe("Daily prod check: Documents", () => {
  ...
  test("Search Documents", async () => {
    ...
    await myDocuments.filesFilter.fillFilesSearchInputAndCheckRequest("FindMe");
...
test.describe("Daily prod check: Trash", () => {
  let myDocuments: MyDocuments;
  let trash: Trash;
